...
public class tc6_updateshoppingcart {
    WebDriver driver;
    ...
    public void the_user_is_in_Homepage_of_the_application() throws Throwable {
        ...
        tc6_updateshoppingcart Addtocart = new tc6_updateshoppingcart();
    }
    
    @When("^the user updates shopping cart$")
    public void the_user_updates_shopping_cart() throws InterruptedException {
